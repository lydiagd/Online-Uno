...
**db_connect.java**  
The equivalent of a Util class that will allow you to do any operations you would need the database for (i.e. you should not need to write any code to connect to the database yourself, I wrote it for you!).
